Engenix- Modern Electrical Store Website
A responsive, single-page application (SPA) built with React.js for Engenix, a local electrical goods provider.
-------------------------------
Project Overview
Engenix is a local electrical goods provider offering a variety of electrical appliances, components, and professional services like installation and maintenance. This project aims to develop a clean, responsive, and interactive website using React.js that reflects the brand's values and services.
-------------------------------
Features
